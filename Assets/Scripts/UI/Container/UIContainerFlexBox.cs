        ...
        public override void UpdateLayout(){
            ...
            for (var i = 0; i < transform.childCount; i++){
                ...
                if (childTransform != null){
                    ...
                    childTransform.anchorMin = new Vector2(cur.x / rect.width, cur.y / rect.height);
                    childTransform.anchorMax =
                        new Vector2((cur.x + size.x) / rect.width, (cur.y + size.y) / rect.height);
