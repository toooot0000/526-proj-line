...
namespace Core.Common.SizeSyncer{
    public class RootSyncSize : MonoBehaviour{
        ...
        [SerializeField] public Camera currentCmr;
        ...
        private void Start(){
            ...
            foreach (var syncer in GetComponentsInChildren<SpriteSizeSyncer>()) syncer.SyncSize();

            foreach (var syncer in GetComponentsInChildren<BaseColliderSizeSyncer>()) syncer.SyncSize();
        }
